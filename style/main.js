...
\n    ";
    ...
    var wedding_url = "http://goo.gl/cbLOhz";
    var rsvp_url = "https://twitter.com/premjithav";
	var train_avail = "http://erail.in/?T=TVC::VLI";
    var venue_address = "\
Achemveettil House\
\nKarnika, Ariyallur P O\
\nMalappuram, Kerala\
\nPin - 676312\
    "
    var ganesha = "\
...
\n\
\n               \
\n 10:45  : Groom's party departs for Wedding Ceremony @ Ariyallur Siva Temple\
\n 11:15  : Muhurtham                  \
\n\
...
\nemail - premjithav@gmail.com\
\nlinkedin - https://www.linkedin.com/in/premjithav \
\ntwitter - https://twitter.com/premjithav \
\nFacebook - https://www.facebook.com/premjithav \
\ngithub - https://github.com/premjithav \
\n\
  ";
    var rsvp = "\
\nYou can RSVP to the event by sending an email to\
\nPremjith (premjithav@gmail.com)\
  ";
	var staton_msg ="\
...
\nPremjith and Amrutha have already got married on 7th April \
\nThankyou.\
\n  "
    if (days_left >= 0) {
      you_are_late = ''
